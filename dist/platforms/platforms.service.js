...
let PlatformsService = class PlatformsService {
    ...
    async create(createPlatformDto) {
        ...
        const platformExists = await this.PlatformRepository.findOneBy(createPlatformDto);
        if (platformExists) {
            throw new common_1.NotFoundException('there is already a platform with this name');
        }
