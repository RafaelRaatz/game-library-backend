...
let ConsolesService = class ConsolesService {
    constructor(ConsoleRepository) {
        this.ConsoleRepository = ConsoleRepository;
    }
    async create(createConsoleDto) {
        const console = this.ConsoleRepository.create(createConsoleDto);
        const consoleExists = await this.ConsoleRepository.findOneBy(createConsoleDto);
        if (consoleExists) {
